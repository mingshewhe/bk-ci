...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_TEMPLATE_INFO` (
    ...
    `CATEGORY` varchar(128) DEFAULT NULL COMMENT '应用范畴',
    `TYPE` varchar(32) DEFAULT 'pipeline' COMMENT '流水线/Stage/JOb/Task类型',
    `LOGO_URL` varchar(512) DEFAULT NULL COMMENT 'LOGO URL地址',
    ...
    `LASTED_SETTING_VERSION` bigint(20) NOT NULL COMMENT '最新设置版本号',
    `SOURCE` varchar(32) NOT NULL COMMENT '自定义、代码库、研发商店',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_TEMPLATE_RESOURCE_VERSION` (
    ...
    `VERSION` int(11) NOT NULL DEFAULT '1' COMMENT '模板版本号',
    `PROJECT_ID` varchar(64) NOT NULL COMMENT '项目ID',
    `TYPE` varchar(32) DEFAULT 'pipeline' COMMENT '流水线/Stage/JOb/Task类型',
    `VERSION_NAME` varchar(64) NOT NULL COMMENT '版本名称',
    ...
    `DRAFT_SOURCE_VERSION` int(11) DEFAULT NULL COMMENT '草稿来源版本',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_TEMPLATE_SETTING_VERSION` (
    `TEMPLATE_ID` varchar(34) NOT NULL COMMENT '模板ID',
    `VERSION` int(11) NOT NULL DEFAULT '1' COMMENT '模板配置版本号',
    `PROJECT_ID` varchar(64) DEFAULT NULL COMMENT '项目ID',
    `NAME` varchar(255) DEFAULT NULL COMMENT '名称',
    `DESC` varchar(1024) DEFAULT NULL COMMENT '描述',
    `VERSION_NAME` varchar(64) NOT NULL COMMENT '版本名称',
