...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_TEMPLATE_INFO` (
    ...
    `LASTED_VERSION` bigint(20) NOT NULL COMMENT '最新版本号',
    `LASTED_VERSION_NAME` varchar(64) NOT NULL COMMENT '最新版本名称',
    `LASTED_VERSION_STATUS` varchar(16) NOT NULL COMMENT '最新版本状态',
    `LASTED_SETTING_VERSION` int(11) DEFAULT NULL COMMENT '最新设置版本号',
    `SOURCE` varchar(32) NOT NULL DEFAULT 'custom' COMMENT '自定义、代码库、研发商店',
    `STORE_FLAG` bit(1) DEFAULT b'0' COMMENT '是否已关联到研发商店',
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_TEMPLATE_RESOURCE_VERSION` (
    ...
    `PROJECT_ID` varchar(64) NOT NULL COMMENT '项目ID',
    `SETTING_VERSION` int(11) DEFAULT NULL COMMENT '模板配置版本号',
    `VERSION` bigint(20) NOT NULL COMMENT '模板版本号',
    `NUMBER` int(11) NOT NULL COMMENT '版本排序号-根据版本发布顺序递增',
    ...
    `MODEL_VERSION` int(11) DEFAULT NULL COMMENT '模板模型版本',
    `TRIGGER_VERSION` int(11) DEFAULT NULL COMMENT '触发器版本',
    `DRAFT_SOURCE_VERSION` bigint(20) DEFAULT NULL COMMENT '草稿来源版本',
    `PARAMS` mediumtext COMMENT '模板参数',
    `ORIGINAL_MODEL` mediumtext COMMENT '模板原始模型',
    `MODEL` mediumtext COMMENT '模板模型',
    `YAML` mediumtext COMMENT 'YAML编排',
    `STATUS` varchar(16) NOT NULL COMMENT '版本状态',
    `BRANCH_ACTION` varchar(32) DEFAULT NULL COMMENT '分支状态',
    `RELEASE_COMMENT` text COMMENT '版本发布描述信息',
    `CREATOR` varchar(64) NOT NULL COMMENT '创建者',
    `UPDATER` varchar(64) DEFAULT NULL COMMENT '修改人',
